...
default_scope = "mmdet"
custom_imports = dict(imports=["mmdet.occlu"], allow_failed_imports=False)
...
hf_sam_pretrain_name = "sam-vit-huge"
hf_sam_pretrain_ckpt_path = "sam-vit-huge/pytorch_model.bin"
